...
platform (3).height := ground_height + 280
platform (3).x1 := 10
...
platform (7).height := ground_height + 450
platform (7).x1 := 370
platform (7).width := 60

platform (8).height := ground_height + 550
platform (8).x1 := 160
platform (8).width := 100
...
platform (10).x1 := 400
platform (10).width := 80

platform (11).height := ground_height + 810
platform (11).x1 := 320
platform (11).width := 80

platform (12).height := ground_height + 900
platform (12).x1 := 400
platform (12).width := 80

platform (13).height := ground_height + 990
platform (13).x1 := 320
platform (13).width := 90

platform (14).height := ground_height + 1050
platform (14).x1 := 220
platform (14).width := 80

platform (15).height := ground_height + 800
platform (15).x1 := 50
platform (15).width := 120
...
platform (20).height := ground_height + 1300
platform (20).x1 := 600
platform (20).width := 39

platform (21).height := ground_height + 1250
platform (21).x1 := 300
platform (21).width := 100

platform (22).height := ground_height + 1400
platform (22).x1 := 500
platform (22).width := 100

platform (23).height := ground_height + 1500
platform (23).x1 := 300
platform (23).width := 80

platform (24).height := ground_height + 1550
platform (24).x1 := 100
platform (24).width := 150

platform (25).height := ground_height + 1600
platform (25).x1 := 100
platform (25).width := 100
...
food (1).img := candyCane
food (1).picx1 := 280                               %picture x coordinates
...
food (4).img := blueLolly
food (4).picx1 := 100
food (4).picy1 := platform (3).height + cakehover
...
food (8).img := chocolate
food (8).picx1 := 100
food (8).picy1 := platform (15).height + cakehover
...
food (11).picx1 := 250
food (11).picy1 := platform (12).height + cakehover
...
food (15).img := birthday
food (15).picx1 := 100
food (15).picy1 := platform (17).height + cakehover
...
food (16).img := cake
food (16).picx1 := 600
food (16).picy1 := platform (20).height + cakehover
...
food (17).img := blueLolly
food (17).picx1 := 100
food (17).picy1 := platform (24).height + cakehover
